...
namespace SeqWithAbp.Web.Menus
{
    public class SeqWithAbpMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public SeqWithAbpMenuContributor(IConfiguration configuration)
        {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            var l = context.GetLocalizer<SeqWithAbpResource>();

            context.Menu.Items.Insert(
                0,
                new ApplicationMenuItem(
                    SeqWithAbpMenus.Home,
                    l["Menu:Home"],
                    "~/",
                    icon: "fas fa-home",
                    order: 0
